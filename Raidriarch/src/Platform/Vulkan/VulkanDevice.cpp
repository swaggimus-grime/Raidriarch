...
namespace Raid {
	VulkanDevice::VulkanDevice(VkInstance& instance, VkSurfaceKHR& surface, VkPhysicalDeviceFeatures& desiredFeatures)
	{
	...
	VkPhysicalDevice VulkanDevice::FindPhysicalDevice(VkInstance& instance, VkSurfaceKHR& surface, VkPhysicalDeviceFeatures& desiredFeatures)
	{
		uint32_t physicalDeviceCount = 0;
		vkEnumeratePhysicalDevices(instance, &physicalDeviceCount, nullptr);
		RAID_ASSERT(physicalDeviceCount, "Failed to find any physical devices!");
		...
		RAID_CORE_ERROR("Failed to find physical device with given features!");
	}

	bool VulkanDevice::FeaturesSupported(VkPhysicalDevice& physicalDevice, VkPhysicalDeviceFeatures& desiredFeatures)
	{
	...
	bool VulkanDevice::ExtensionsSupported(VkPhysicalDevice& physicalDevice)
	{
	...
	bool VulkanDevice::SwapChainSupported(VkPhysicalDevice& physicalDevice, VkSurfaceKHR& surface)
	{
	...
	VkDevice VulkanDevice::FindDevice(VkInstance& instance, VkPhysicalDeviceFeatures& desiredFeatures)
	{
		...
		VkDevice device;
		RAID_VK_VALIDATE(vkCreateDevice(m_PhysicalDevice, &deviceInfo, nullptr, &device), "Failed to create device!");
		return device;
	}

	QueueFamilies& VulkanDevice::FindQueueFamilies(VkPhysicalDevice& physicalDevice, VkSurfaceKHR& surface)
	{
		...
		RAID_ASSERT(complete, "Failed to find necessary queue families!");
