...
namespace Raid {
	...
	void EditorLayer::OnAttach()
	{
		...
		m_JokerTexture = Texture2D::Create("assets/textures/joker.png");
	...
	void EditorLayer::OnUpdate(Timestep ts)
	{
...

		{
			...
			Renderer2D::DrawRotatedQuad({ -2.0f, 0.0f, 0.0f }, { 1.0f, 1.0f }, rotation, m_JokerTexture, 20.0f);
			Renderer2D::EndScene();
	...
	void EditorLayer::OnImGuiRender()
	{
		...
		// Resize
		if (Raid::FramebufferProperties props = m_Framebuffer->GetProperties();
